...
function getQuote() {
	...
	$quotes[] = 'We\'re mortal -- which is to say, we\'re ignorant, stupid, and sinful --
	but those are only handicaps.  Our pride is that nevertheless, now and then, we do our best.
